<div align="center">
  ...
  <h3 align="center">SaaS SiteSprout</h3>

   <div align="center">
"Web Design Simplified: Your Path to Stunning Sites!"    </div>
</div>
...
This repository contains the code corresponding to an in-depth tutorial available on the README . 

## <a name="introduction">🤖 Introduction</a>

A minimalistic Web Designer like <a href = "https://www.figma.com">Figma </a> to show how to add real-world features like live collaboration with cursor chat, comments, reactions, and drawing designs (shapes, image upload) on the canvas using fabric.js.
...
```bash
git clone git@github.com:Lakshya-GG/SaaS-SiteSprout.git
cd figma-ts
```
...
Create a new file named `.env.local` in the root of your project and add your api key.
